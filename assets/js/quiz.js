$(document).ready(function () {
     ...
     const timeRanOutMessages = [
          "Time's up! ⏰",
          "You ran out of time! ⏳",
          "Oops, time ran out! 😵",
          "Try to be quicker next time! 🕒",
          "The clock beat you this time! 🕰️"
     ];
     ...
     function startQuiz() {
          ...
          function showTimeRanOutMessage() {
               const bubble = $(".bubble-chat");
               const bubbleText = $(".bubble-text");
           
               const message = timeRanOutMessages[Math.floor(Math.random() * timeRanOutMessages.length)];
               bubbleText.text(message);
               bubble.addClass("show");
